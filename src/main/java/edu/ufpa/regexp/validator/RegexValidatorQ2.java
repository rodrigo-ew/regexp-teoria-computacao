...
public class RegexValidatorQ2 {
    ...
    private final Pattern patternA = Pattern.compile("((HM)|(MH))(((h*m+h*m+)+)|((h+m*)+))");
    ...
    private final Pattern patternD = Pattern.compile("((MM)|(HH))((hm)|(mh))[hm]{2}[hm]*((hm)|(mh))");
    private final Pattern patternE = Pattern.compile("((MM)|(HH))(((hm)*h?)|((mh)*m?))");
